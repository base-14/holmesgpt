...
| [<img src="images/integration_logos/base14-scout-icon.png" alt="Base14 Scout" width="20" style="vertical-align: middle;"> **Base14 Scout**](https://holmesgpt.dev/data-sources/builtin-toolsets/base14-scout/) | Services, traces, logs, metrics, and alerts via MCP |
